Creamos una carpeta en la terminal dentro de git,llamada tp1_practica y usamos el comando mkdir tp1_practica y abrimos la carpeta con el comando cd tp1_practica y luego inicializamos con git init. 
